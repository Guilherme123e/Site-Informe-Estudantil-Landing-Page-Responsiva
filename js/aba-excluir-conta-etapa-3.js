...
// Função para limpar todos os dados de cadastro do localStorage
function limparDadosCadastro() {
  localStorage.removeItem("cadastro_nome");
  localStorage.removeItem("cadastro_usuario");
  localStorage.removeItem("ntf1");
  localStorage.removeItem("ntf2");
  localStorage.removeItem("ntf3");
  localStorage.removeItem("ntf4");
  localStorage.removeItem("cadastro_email");
  localStorage.removeItem("cadastro_senha");
  localStorage.removeItem("cadastro_telefone");
  localStorage.removeItem("cadastro_cpf");
  localStorage.removeItem("cadastro_rg");
  localStorage.removeItem("cadastro_endereco");
  localStorage.removeItem("cadastro_data_nascimento");
  localStorage.removeItem("cadastro_genero");
  localStorage.removeItem("estadoPlano");
...
function validarCodigo() {
  ...
  if (codigoInput === codigoSimulado) {
    ...
    window.location.href = 'aba-excluir-conta-etapa-4.html';
  } else {
